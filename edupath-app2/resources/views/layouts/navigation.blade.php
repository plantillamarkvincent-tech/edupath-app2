        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            @else
                <div class="px-4 space-y-2">
                    <a href="{{ route('login') }}" class="block text-sm text-gray-600 dark:text-gray-300 hover:underline">{{ __('Log in') }}</a>
                    <a href="{{ route('register') }}" class="block text-sm text-indigo-600 hover:underline">{{ __('Register') }}</a>
                </div>
            @endauth
        </div>
    </div>
